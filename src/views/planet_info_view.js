...
PlanetInfoView.prototype.render = function (planet) {
  ...
  planetInfo.textContent = `The name of the planet is ${planet.name}, the orbit is ${planet.orbit}, the day is ${planet.day}, the surface area is ${planet.surfaceArea}, the volume is ${planet.volume}, the gravity is ${planet.gravity}, there are ${planet.moons} moons. ${planet.image}`
